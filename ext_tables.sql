...
CREATE TABLE tx_qccomments_domain_model_comment (
			...
			deleted_by_user_uid int,
			deleting_date varchar(20) DEFAULT '' NOT NULL,
			hidden_by_user_uid int,
			hidden_date varchar(20) DEFAULT '' NOT NULL,
			fixed smallint(5) unsigned DEFAULT '0' NOT NULL,
			fixed_by_user_uid int,
			fixed_date varchar(20) DEFAULT '' NOT NULL,
			tstamp int(11) unsigned DEFAULT '0' NOT NULL,
			crdate int(11) unsigned DEFAULT '0' NOT NULL,
			hidden tinyint(4) unsigned DEFAULT '0' NOT NULL,
			hidden_comment tinyint(4) unsigned DEFAULT '0' NOT NULL,
